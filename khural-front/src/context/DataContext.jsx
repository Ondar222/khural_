  ...
  React.useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        // Применяем маппинг созывов
        const withConvocation = applyConvocationMapping(normalized, convocationByNormalizedName);
        ...
        // Обработка ошибок
        if (import.meta.env.DEV) {
          console.warn("Ошибка загрузки депутатов:", e);
        }
        markLoading("deputies", false);
      }
