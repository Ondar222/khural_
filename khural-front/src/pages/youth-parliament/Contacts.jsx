...
export default function YouthParliamentContacts() {
  ...
  const description = lang === "ty" 
    ? "Аныяктар Хуралының харылзаа медээлери үрүндүр салдынган." 
    : lang === "ru" 
      ? "Контактная информация Молодежного Хурала будет размещена в ближайшее время." 
      : "Contact information for the Youth Parliament will be posted soon.";
