...
import AdminCommissionsList from "./AdminCommissionsList.jsx";
    ...
    <div className="admin-card" style={{ marginBottom: 16 }}>
      <div style={{ display: "grid", gap: 10, maxWidth: 520 }}>
        ...
        <div style={{ opacity: 0.8, fontSize: 13, lineHeight: 1.45 }}>
          Чтобы редактировать и добавлять комиссии, выполните вход.
        </div>
        <Input
          placeholder="Email"
  ...
  return (
    ...
    >
      ...
      <AdminCommissionsList
        items={adminData.commissions}
        onReload={adminData.reload}
        onDelete={adminData.deleteCommission}
        busy={adminData.busy}
