...
function toReceptionScheduleText(schedule) {
  ...
  if (schedule && typeof schedule === "object" && !Array.isArray(schedule)) {
    return typeof schedule.notes === "string" ? schedule.notes : "";
  }
...
export default function AdminDeputiesV2({
  ...
  const [newFactionTargetForm, setNewFactionTargetForm] = React.useState(null); // "create" | "edit" | null
          ...
          <Button
            onClick={() => {
              ...
              editForm.setFieldsValue({
                ...
                role: row.role || "",
                receptionSchedule:
                  typeof row.receptionSchedule === "string"
                    ? row.receptionSchedule
                    : row.receptionSchedule && typeof row.receptionSchedule === "object"
                      ? row.receptionSchedule.notes || ""
                      : "",
                  ...
                  <div>
                    ...
                    <div style={{ padding: 8, borderTop: "1px solid #f0f0f0" }}>
                      <Button
                        ...
                        block
                        onClick={() => {
                          setNewFactionTargetForm("create");
                          setNewFactionOpen(true);
                        }}
                        disabled={!canWrite}
                      >
      ...
      <Modal
        ...
        onOk={async () => {
          ...
          try {
            ...
            if (newFactionTargetForm === "edit") {
              editForm.setFieldValue("faction", name);
            } else {
