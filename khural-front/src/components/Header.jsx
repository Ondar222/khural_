        ...
        {!mobileSection && (
          <>
            <div className="mobile-drawer__top">
              <div className="sheet-card social-card mobile-social-card">
                <div className="social-card__header">
                  <img
                    ...
                    alt=""
                  />
                  <div className="social-card__title">Социальные сети</div>
                </div>
                <div className="social-icons">
                  <a className="sicon" href="https://vk.com" target="_blank" rel="noreferrer" aria-label="VK">
                  ...
                  <a className="sicon" href="https://t.me" target="_blank" rel="noreferrer" aria-label="Telegram">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                      <path fill="#29b6f6" d="M24 4A20 20 0 1 0 24 44A20 20 0 1 0 24 4Z"></path>
                      <path
                        fill="#fff"
